...
const { getSelectedAddressController } = require("../controllers/getSelectedAddress");
...
exports.handler = async (event) => {
    ...
    } else if(event.resource === apiRoutes.GET_SELECTED_ADDRESS) {
        return await getSelectedAddressController(event);
    }
};
